    ...
    return (
        <>
            ...
            <main className='w-screen h-fit md:h-screen flex '>
                ...
                <VerticalLine />
                <button onClick={handleHambarger} className=' absolute w-fit h-fit top-[20px] left-48'><img className='w-5 h-5 text-white' src="/hambarger.svg" alt="" /></button>
                <section className='md:w-[50%] W-[100%] h-full mb-2'>
                    {props.data}
                </section>
                <VerticalLine />
